...
http.createServer((req, res) => {
  ...
  if (pathname === '/' || pathname === '/index.html' || pathname.startsWith('/id=') || pathname.startsWith('/live=')) return sendFile(res, path.join(__dirname, 'index.html'), 'text/html; charset=utf-8');
